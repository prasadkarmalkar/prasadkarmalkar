		...
		<main className='p-4 sm:p-8'>
			<section className='h-[calc(100vh-100px)] flex flex-col justify-between items-center gap-20'>
				<div className='flex-1 flex flex-col justify-center items-center'>
					...
					<button className='group mt-20 flex border px-7 py-3 rounded-full items-center gap-2 hover:bg-white hover:text-black transition-all duration-300'>Lets Connect <FaAngleRight className='group-hover:ml-2 transition-all duration-300' /></button>
				</div>
				<FaChevronDown />
			</section>
			<RecentProjects />
