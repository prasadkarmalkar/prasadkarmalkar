...
function RecentBlogs() {
	return (
		<section className='my-20 m-auto'>
			<h2 className='text-center text-4xl'>Recent <strong className='text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-violet-600'>Writings</strong></h2>
