	...
	return (
		<section className='mt-20 max-w-screen-lg m-auto'>
			...
			<div className='mt-20 grid grid-cols-1 grid-rows-7 sm:grid-cols-8 sm:grid-rows-6 gap-10 justify-center'>
				<div className='relative row-span-2 sm:row-span-2 sm:col-span-8 lg:col-span-5 lg:row-span-4  bg-gray-950 rounded-2xl'>
				...
				<div className='row-span-1 sm:col-span-4 sm:row-span-1 lg:col-span-3 lg:row-span-2 bg-gray-950  rounded-2xl'>
					<h3 className='text-2xl sm:text-3xl my-6 text-center font-semibold '>
						BackEnd
					</h3>
					<ul className='text-5xl flex gap-24 justify-evenly flex-wrap p-10'>
				...
				<div className='row-span-2 sm:col-span-8 sm:row-span-2 lg:col-span-6 lg:row-span-2 bg-gray-950  rounded-2xl'>
					<h3 className='text-2xl sm:text-3xl my-6 text-center font-semibold '>
						Tools
					</h3>
					<ul className='text-5xl flex gap-24 justify-evenly flex-wrap p-10'>
				...
				<div className='row-span-1 sm:col-start-3 sm:row-span-1 sm:col-end-7 lg:col-span-2 lg:row-span-2 bg-gray-950  rounded-2xl'>
					<h3 className='text-2xl sm:text-3xl my-6 text-center font-semibold'>
						CMS
					</h3>
					<ul className='text-5xl flex gap-24 justify-evenly flex-wrap p-10'>
